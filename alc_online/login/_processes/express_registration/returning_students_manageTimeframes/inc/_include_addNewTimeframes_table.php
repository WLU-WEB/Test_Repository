<FORM NAME="form_capture" METHOD="post" ACTION="<?php echo $PHP_SELF .'?action=ExpressRegistrationTimeFrames&subAction=addNewTimeframes'?>">
<table width="100%"  border="0" cellspacing="0" cellpadding="3">
  ...
  <tr align="left" valign="middle">
    ...
    <td width="70%" valign="top">Each timeframes <strong>must</strong> have a unique start and end date from previous and future timeframes. Example: if timeframe 1: March 4, 2014 - April 5, 2014 then timeframe 2: April 6, 2014 - May 7, 2014, and timeframe 3: May 8, 2014 - June 8, 2014. Registration closes on midnight.</td>
  </tr>
  <tr align="left" valign="middle">
