      ...
      <TD VALIGN="TOP">
          <TABLE WIDTH="100%"  BORDER="0" CELLSPACING="0" CELLPADDING="3">
            ...
            <TR ALIGN="LEFT" VALIGN="MIDDLE">
              ...
              <TD WIDTH="90%" VALIGN="TOP"><?php if(count($errors)>0) { include ("/www/forms/accessible_learning/alc_student_applications/login/includes/_error_message.php"); } ?></TD>
            </TR>
            <TR ALIGN="LEFT" VALIGN="MIDDLE">
              <TD VALIGN="TOP"><div align="right"><strong><font color="#CC0000"><?PHP echo " $image_08"; ?></font></strong></div></TD>
              <TD VALIGN="TOP"><strong>Which classe(es) were you a Note-taker for this semester?</strong></TD>
            </TR>
            <TR ALIGN="LEFT" VALIGN="MIDDLE">
              <TD VALIGN="TOP">&nbsp;</TD>
            ...
            <TR ALIGN="LEFT" VALIGN="MIDDLE">
              <TD VALIGN="TOP"><div align="right"><strong><font color="#CC0000"><?PHP echo " $image_01"; ?></font></strong></div></TD>
              <TD VALIGN="TOP"><strong>How did you exchange your notes?</strong></TD>
            </TR>
            <TR ALIGN="LEFT" VALIGN="MIDDLE">
              <TD VALIGN="TOP">&nbsp;</TD>
