...
<FORM NAME="theForm" ACTION="<?php echo "$PHP_SELF?action=alternateFormatRequestFirstTime"; ?>" METHOD="post">
...
<?PHP
//echo "<INPUT TYPE=hidden NAME=timeframe VALUE='$timeframe_unique_id_fdB'>"; #not required for first time users (since there is NO timeframe)
