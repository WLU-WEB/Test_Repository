        ...
        <li>Textbooks must be purchased before any order will be executed--Keep your receipts!</li>
           <li>Your request will be considered in order of receipt following after requests that have been submitted on time</li>       
            ...
            if ($_SESSION[campus_fF] == 'brantford'){
                echo "<li><a href='LBAlt-FormatMissedDeadlineForm.docx' target='_blank'>Download and complete the following form with ALL information</a> (PDF form will open in a new window or tab)</li>";
            }
            else{
                echo "<li><a href='Alt-FormatMissedDeadlineForm.pdf' target='_blank'>Download and complete the following form with ALL information</a> (PDF form will open in a new window or tab)</li>";
            }
            ?>
