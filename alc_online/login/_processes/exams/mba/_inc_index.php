...
<form action="<?php echo "$PHP_SELF?action=mbaExams"; ?>" method="post" name="theForm" id="theForm">
...
echo "</select>";
?> <?php if($error_term_fF=="1") { echo "$errorImage"; } ?>
</div>

<BR />

<div class="label"><label for="Program">Program <?PHP echo "$image_red_bullet"; ?></label></div>
<div class="input">
<?php 
if($error_program_fF=='1') { echo "<SELECT NAME='program_fF' class='form' ID='Program' style='background-color: #FFFF99'>"; }
	else { echo "<SELECT NAME='program_fF' class='form' ID='Program'>"; }
if($program_fF) { echo "<option value='$program_fF' SELECTED>$program_fF</option>"; }
	else { echo "<option value='' SELECTED>Program</option>"; }
echo "<option value='Waterloo Full-Time'>Waterloo Full-Time</option>";
echo "<option value='Waterloo Part-Time'>Waterloo Part-Time</option>";
echo "<option value='Toronto Full-Time'>Toronto Full-Time</option>";
echo "<option value='Toronto Part-Time'>Toronto Part-Time</option>";
echo "</select>";
?>
<?php if($error_program_fF=="1") { echo "$errorImage"; } ?>
</div>

<BR />

<div class="label"><label for="writing_location">Writing Location <?PHP echo "$image_red_bullet"; ?></label></div>
<div class="input">
<?php if($writing_location_fF=='Toronto') { echo "<INPUT TYPE='radio' NAME='writing_location_fF' VALUE='Toronto' ID='toronto_selection' CHECKED>"; } else { echo "<INPUT TYPE='radio' NAME='writing_location_fF' VALUE='Toronto' ID='toronto_selection'>"; } ?><label for="toronto_selection">Toronto</label>
<?php if($writing_location_fF=='Waterloo') { echo "<INPUT TYPE='radio' NAME='writing_location_fF' VALUE='Waterloo' ID='waterloo_selection' CHECKED>"; } else { echo "<INPUT TYPE='radio' NAME='writing_location_fF' VALUE='Waterloo' ID='waterloo_selection'>"; } ?><label for="waterloo_selection">Waterloo</label>
<?php if($error_writing_location_fF=="1") { echo "$errorImage"; } ?>
</div>
...
<br />
<?php if($acc_05_fF=='Orthopaedic chair') { echo "<INPUT TYPE='checkbox' NAME='acc_05_fF' VALUE='Orthopaedic chair' ID='accomodation_5' CHECKED>"; } else { echo "<INPUT TYPE='checkbox' NAME='acc_05_fF' VALUE='Orthopaedic chair' ID='accomodation_5'>"; } ?><label for="accomodation_5">Orthopaedic chair</label>
<br />
