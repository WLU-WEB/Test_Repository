...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
        ...
        <tr align="left" valign="middle">
          <td align="right" valign="top" class="fieldText"><label for="Program">Program</label>
          ...
          <td valign="top"><?php 
                                            ...
                                            echo "</select>";
											?>
            <?php if($error_program_fF=="1") { echo "$errorImage"; } ?></td>
        </tr>
        <tr align="left" valign="middle">
          <td align="right" valign="top" class="fieldText">Writing Location <?PHP echo "$image_red_bullet"; ?></td>
          <td valign="top"><?php if($writing_location_fF=='Toronto') { echo "<INPUT TYPE='radio' NAME='writing_location_fF' VALUE='Toronto' ID='toronto_selection' CHECKED>"; } else { echo "<INPUT TYPE='radio' NAME='writing_location_fF' VALUE='Toronto' ID='toronto_selection'>"; } ?>
            <label for="toronto_selection">Toronto</label>
            <?php if($writing_location_fF=='Waterloo') { echo "<INPUT TYPE='radio' NAME='writing_location_fF' VALUE='Waterloo' ID='waterloo_selection' CHECKED>"; } else { echo "<INPUT TYPE='radio' NAME='writing_location_fF' VALUE='Waterloo' ID='waterloo_selection'>"; } ?>
            <label for="waterloo_selection">Waterloo</label>
          <?php if($error_writing_location_fF=="1") { echo "$errorImage"; } ?></td>
        </tr>
        <tr align="left" valign="middle">
