...
<a href="<?PHP $PHP_SELF?>?action=alternateFormatRequestTimeFrames&amp;subAction=addNewTimeframes">
	  ...
	  <br />
      <a href="<?PHP $PHP_SELF?>?action=alternateFormatRequestTimeFrames&amp;subAction=viewExistingTimeframes">
	  <table width="100%%" border="0" cellpadding="5" class="border_a">
	    <tr class="myborder">
	      <td width="1%" align="left" valign="top"><img src="_img/_icons/alternate_format.png" width="128" height="128" alt="Alternate Format Request" /></td>
