...
echo "
	...
	<div id='menu1'>
	<ul>
		<li><A HREF='$PHP_SELF?action=ExpressRegistrationReturning'>$i15 Express Registration</A></li>
	";
echo "
	</ul>
	</div>
...
echo "
	...
	";
if($ALC_username=="kova8670a" || $ALC_username=="akovacsik" || $ALC_username=="dfacey")
	{
	echo"
...
echo "
	...
	";
if($ALC_username=="kova8670a" || $ALC_username=="akovacsik" || $ALC_username=="jbruyea" || $ALC_username=="jhunt" || $ALC_username=="gpage" || $ALC_username=="jfridrich")
	{
	echo"
...
if($ALC_username=="akovacsik" || $ALC_username=="iadebowale")
	{
	echo"
	<li><A HREF='$PHP_SELF?action=manageTimeframes'>$image_05 Add Registrations</A></li>
	";
	}
if($ALC_username=="akovacsik" || $ALC_username=="jeulenberg" || $ALC_username=="eriggin" || $ALC_username=="iadebowale" )
	{
	echo"
